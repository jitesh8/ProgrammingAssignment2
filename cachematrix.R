# The Matrix inversion is usually a costly computation and there may be some benefit to caching the inverse of a
...
# This function also assumes that the matrix is always invertible.
